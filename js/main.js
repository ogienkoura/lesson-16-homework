...
let getDateAgo = (d, days) => {
  ...
  const result = date.toLocaleString().replace(/(\d.*),\s+(\d.*)/gu, "$1");
  return result;
};
...
let car = new Car(2000, "Logan", "Renault", 2016);
let car2 = new Car(4000, "Focus", "Ford", 2022);
